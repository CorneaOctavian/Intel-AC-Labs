...
if __name__ == '__main__':
    ...
    if not os.path.isdir("./input"):
        ...
        print("Folder-ul de intrare lipsea. S-au generat cu succes date de intrare.")

    else :
        if len(os.listdir("./input")) == 0:
            generate_dataset(num_of_samples = NUM_OF_SAMPLES)
            print("Folder-ul de intrare a fost gol. S-au generat cu succes date de intrare.")
